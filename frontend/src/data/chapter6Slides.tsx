...
# 4. Easy to add new roles (e.g., Designer, QA)`,
  ...
  // Slide 10: LangGraph Introduction
  {
    ...
    type: 'content',
    content: (
      <div className="flex flex-col justify-center h-full p-12 bg-gradient-to-br from-orange-50 to-red-50">
        <div className="flex items-center space-x-4 mb-8">
          <div className="text-6xl">🔀</div>
          <div>
            <h2 className="text-5xl font-bold text-orange-700">LangGraph</h2>
            <p className="text-xl text-black">Graph-Based Workflow Orchestration</p>
          </div>
        </div>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 max-w-5xl">
          <div className="p-6 bg-white rounded-xl shadow-md">
            ...
            <div className="space-y-3">
              <div className="p-3 bg-orange-50 rounded-lg border-l-4 border-orange-500">
                <p className="font-semibold text-black text-sm mb-1">Node</p>
                <p className="text-xs text-black">A function representing an operation: LLM call, tool execution, data transformation</p>
              </div>
              <div className="p-3 bg-red-50 rounded-lg border-l-4 border-red-500">
                <p className="font-semibold text-black text-sm mb-1">Edge</p>
                <p className="text-xs text-black">Defines data flow between nodes. Can be conditional (if/else routing)</p>
              </div>
              <div className="p-3 bg-pink-50 rounded-lg border-l-4 border-pink-500">
                <p className="font-semibold text-black text-sm mb-1">Cycle Support</p>
                <p className="text-xs text-black">Unlike linear chains, LangGraph graphs can loop back to previous nodes (critical for Reflection)</p>
              </div>
            </div>
          </div>
          <div className="p-6 bg-white rounded-xl shadow-md">
            ...
            <div className="space-y-2">
              <div className="flex items-center space-x-2 p-2 bg-blue-50 rounded">
                ...
                <span className="text-sm text-black">Generate Node: LLM writes essay draft</span>
              </div>
              <div className="flex items-center space-x-2 p-2 bg-purple-50 rounded">
                <span className="text-lg">2️⃣</span>
                <span className="text-sm text-black">Reflect Node: Critic identifies weaknesses</span>
              </div>
              <div className="flex items-center space-x-2 p-2 bg-green-50 rounded">
                <span className="text-lg">🔁</span>
                <span className="text-sm text-black">Edge loops back to Generate if quality < threshold</span>
              </div>
              <div className="flex items-center space-x-2 p-2 bg-orange-50 rounded">
                <span className="text-lg">✅</span>
                <span className="text-sm text-black">Terminate when quality score > 0.9</span>
              </div>
            </div>
          </div>
        </div>
        <div className="mt-8 grid grid-cols-2 gap-6">
          <div className="p-6 bg-gradient-to-r from-green-400 to-emerald-500 rounded-xl shadow-lg text-white">
            <h3 className="font-bold mb-2 text-lg">✅ Advantages</h3>
            <ul className="text-sm space-y-1">
              <li>• Natural cycle support for iterative workflows</li>
              <li>• Visual graph representation</li>
              <li>• Seamless LangChain integration</li>
              <li>• Conditional routing (if/else logic)</li>
            </ul>
          </div>
          <div className="p-6 bg-gradient-to-r from-red-400 to-pink-500 rounded-xl shadow-lg text-white">
            <h3 className="font-bold mb-2 text-lg">⚠️ Best For</h3>
            <ul className="text-sm space-y-1">
              <li>• Reflection-based agents</li>
              <li>• Complex decision trees</li>
              <li>• Scenarios with retry/correction logic</li>
              <li>• Workflows needing visual debugging</li>
            </ul>
          </div>
        </div>
      </div>
